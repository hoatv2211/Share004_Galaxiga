        ...
        void IPreprocessBuildWithReport.OnPreprocessBuild(BuildReport report)
        {
            ...
            catch (Exception ex)
            {
                UnityEngine.Debug.LogWarning(
                    "[Odin Inspector] AssemblyImportSettingsAutomation skipped due to a reflection incompatibility " +
                    "with this Unity version. Please update Odin Inspector to a version that supports Unity 6.\n" + ex);
            }
        }
